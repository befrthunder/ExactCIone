...
WhyperCI_N(x=50,n=50,M=800,conf.level = 0.95)
# It shows CIs for all the sample point When "details=TRUE".
WhyperCI_N(x=10,n=50,M=800,conf.level = 0.95,details=TRUE)
```

The one-sided $1-\alpha$ CI for $N$ is the one-sided Clopper-Pearson type interval (Konijn, 1973).
```{r}
WhyperCI_N_lower(x=0,n=50,M=800,conf.level = 0.95)
WhyperCI_N_lower(x=0,n=50,M=800,conf.level = 0.95,details=TRUE)
WhyperCI_N_upper(x=0,n=50,M=800,conf.level = 0.95)
WhyperCI_N_upper(x=0,n=50,M=800,conf.level = 0.95,details=TRUE)
```
...
WhyperCI_M(x=0,n=50,N=2000,conf.level = 0.95)
WhyperCI_M(x=0,n=50,N=2000,conf.level = 0.95,details = TRUE)
```
The one-sided $1-\alpha$ CI for $M$ is the one-sided Clopper-Pearson type interval (Konijn, 1973).
```{R}
WhyperCI_M_lower(X=0,n=50,N=2000,conf.level = 0.95)
WhyperCI_M_lower(X=0,n=50,N=2000,conf.level = 0.95,details = TRUE)
WhyperCI_M_upper(X=0,n=50,N=2000,conf.level = 0.95)
WhyperCI_M_upper(X=0,n=50,N=2000,conf.level = 0.95,details = TRUE)
